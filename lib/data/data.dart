...
List meals_list = [
  MealInfo(
      ...
      liked: false),
  MealInfo(
      mealName: 'Pizza viande',
      price: 200,
      time: 15,
      image: 'pizzaViande.jpg',
      id: '3',
      glutenFree: false,
      vegetarian: false,
      vegan: false,
      liked: false),
  MealInfo(
      mealName: 'Pizza poulet',
      price: 200,
      time: 15,
      image: 'pizzaPoulet.jpg',
      id: '3',
      glutenFree: false,
      vegetarian: false,
      vegan: false,
      liked: false),
  MealInfo(
      mealName: 'Sandwitch chawarma',
      price: 250,
      time: 10,
      image: 'sandwitchCat.jpg',
      id: '1',
      glutenFree: false,
      vegetarian: true,
      vegan: false,
      liked: false),
  MealInfo(
      mealName: 'Sandwitch escalope',
      price: 250,
      time: 10,
      image: 'sandEscalope.jpg',
      id: '1',
      glutenFree: false,
      vegetarian: true,
      vegan: false,
      liked: false),
  MealInfo(
      mealName: 'Sandwitch mariné',
      price: 250,
      time: 10,
      image: 'sandMariné.jpg',
      id: '1',
      glutenFree: false,
      vegetarian: true,
      vegan: true,
  ...
  MealInfo(
      ...
      liked: false),
  MealInfo(
      mealName: 'Soufflé au fromage',
      price: 50,
      time: 5,
      image: 'souffletFrom.jpg',
      id: '6',
      glutenFree: false,
      vegetarian: true,
      vegan: true,
  ...
  MealInfo(
      ...
      liked: false),
  MealInfo(
      mealName: 'Khobz El Bey',
      price: 150,
      time: 0,
      image: 'khobzElBey.jpg',
      id: '10',
      glutenFree: false,
      vegetarian: true,
      vegan: true,
...
List details = [
  ...
  MealDetails(
      ingredients:
          "1) Pate à pizza\n2) Sauce tomate\n3) gruyere rapé\n4) Huile d'olive\n5) Poivre\n6) Sel\n7) 250g de boeuf haché",
      country: 'Algeria',
      mealName: 'Pizza viande'),
  MealDetails(
      ingredients: 'ok', country: 'Algeria', mealName: 'Sandwitch chawarma'),
  MealDetails(
      ingredients: 'ok', country: 'Algeria', mealName: 'Hamburger au poulet'),
